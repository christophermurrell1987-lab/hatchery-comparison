...
# ============================================
# This is the standard, strict filtering you expect.
# It simply removes any rows that don't match your Date or Hatchery selection.
if not df.empty:
...
# MAIN DISPLAY
# ============================================
st.success(f"✓ Found **{len(multi_hatchery_batches)}** shared batches between the selected hatcheries")
